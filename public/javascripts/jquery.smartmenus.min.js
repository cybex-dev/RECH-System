        ...
        hideAll: function () {
            ...
            init: function (e) {
                ...
                if (this.$firstSub = this.$root.find("ul").each(function () {
                    ...
                    var r = /(index|default)\.[^#\?\/]*/i, h = /#.*/, u = window.location.href.replace(r, ""),
                        l = u.replace(h, "");
                ...
                var e, n, a = i.dataSM("parent-a"), r = i.parent().parent(), h = i.dataSM("level"),
                    u = this.getWidth(i), l = this.getHeight(i), c = a.offset(), d = c.left, m = c.top,
                    p = this.getWidth(a), f = this.getHeight(a), v = t(window), S = v.scrollLeft(), b = v.scrollTop(),
                    M = this.getViewportWidth(), g = this.getViewportHeight(),
                ...
                var s, o = t.dataSM("scroll"), n = t.dataSM("scroll-arrows"), a = parseFloat(t.css("margin-top")),
                ...
                var e = i.dataSM("scroll"), s = t(window),
