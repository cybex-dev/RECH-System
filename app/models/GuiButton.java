...
public class GuiButton {
    ...
    public static GuiButton netSaveFeedback = new GuiButton("Save Feedback","btnSaveFeedback",  controllers.ReviewSystem.routes.ReviewHandler.saveAssignedReviewers());
    public static GuiButton posSubmitFeedback = new GuiButton("Submit Feedback", "btnSubmitFeedback", controllers.ReviewSystem.routes.ReviewHandler.doAssignReviewers());
